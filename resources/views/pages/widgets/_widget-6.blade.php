...
<div class="card card-custom {{ @$class }}">
    ...
    <div class="card-header border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label font-weight-bolder text-dark"> Setoran Terbaru </span>
        ...
        <div class="card-toolbar">
            <ul class="nav nav-pills nav-pills-sm nav-dark-75">
                ...
                <li class="nav-item">
                    <a class="nav-link py-2 px-4 active" data-toggle="tab" href="#kt_tab_pane_1_3"> Hari ini </a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <table class="table table-borderless table-vertical-center">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="pl-0">
                            <a href="#" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg"> Rezky Maulana </a>
                            <div>
                                <span class="font-weight-bolder"> Halaqoh: </span>
                                <a class="text-muted font-weight-bold text-hover-primary" href="#"> Ust. Riki </a>
                            </div>
                        </td>
                        <td class="text-right">
                        ...
                        <td class="text-right">
                            <span class="label label-lg label-light-primary label-inline"> DI-SETUJUI </span>
                        </td>
